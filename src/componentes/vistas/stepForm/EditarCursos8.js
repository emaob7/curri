...
class EditarCursos8 extends Component  {
  state = {
    datosp: {
      tit8: "", 
      ins8: "",
  ...
  render() {
    ...
    return (
      <React.Fragment>
          ...
          <Papel>
          <h1>8. Cursos de Capacitación</h1>
...
export default consumerFirebase(EditarCursos8);
