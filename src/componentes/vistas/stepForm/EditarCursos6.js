...
class EditarCursos6 extends Component  {
  state = {
    datosp: {
      tit6: "", 
      ins6: "",
  ...
  render() {
    ...
    return (
      <React.Fragment>
          ...
          <Papel>
          <h1>6. Cursos de Capacitación</h1>
...
export default consumerFirebase(EditarCursos6);
