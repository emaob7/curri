...
class EditarHerramientas4 extends Component  {
  state = {
    datosp: {
      her4: "", 
      nive4: "",
...
export default consumerFirebase(EditarHerramientas4);
