...
class Idiomas2 extends Component  {
  state = {
    datosp: {
      idi2: null, 
      niv2: null,
...
guardarDatosA = () => {
  ...
  this.props.firebase.db
      ...
      .set(datosp, {merge: true})
     .then( success => {
          this.props.history.push("/add/idiomas3/"+ id); 
      }) 
...
export default consumerFirebase(Idiomas2);
