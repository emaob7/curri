...
class EditarCursos5 extends Component  {
  state = {
    datosp: {
      tit5: "", 
      ins5: "",
  ...
  render() {
    ...
    return (
      <React.Fragment>
          ...
          <Papel>
          <h1>5. Cursos de Capacitación</h1>
...
export default consumerFirebase(EditarCursos5);
