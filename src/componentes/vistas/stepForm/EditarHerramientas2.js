...
class EditarHerramientas2 extends Component  {
  state = {
    datosp: {
      her2: "", 
      nive2: "",
...
export default consumerFirebase(EditarHerramientas2);
